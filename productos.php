...
if (empty($existe) && $id_user != 1) {
    ...
    if (!empty($_POST)) {
        ...
        $alert = "";
        if (empty($codigo) || empty($proveedor)|| empty($producto) || empty($precio) || $precio <  0 || empty($cantidad) || $cantidad < 0) {
            ...
            if ($result > 0) {
				...
				$query_insert = mysqli_query($conexion,"INSERT INTO producto(codigo,descripcion,precio,existencia,usuario_id,proveedor) values ('$codigo', '$producto','$precio','$cantidad','$usuario_id','$proveedor')");
                if ($query_insert) {
     ...
     <div class="modal-dialog" role="document">
         <div class="modal-content">
             ...
             <div class="modal-body">
               ...
               <?php
                $query_proveedor = mysqli_query($conexion, "SELECT codproveedor, nombre FROM proveedores ORDER BY nombre ASC");
